...
let c1 = createCanvas({ width: $(".twins").width(), height: $(".twins").height() });
let c2 = createCanvas({ width: $(".twins").width(), height: $(".twins").height() });
let c3 = createCanvas({ width: $(".twins").width(), height: $(".twins").height() });

let tela = c1.canvas;
let canvas = c1.context;

// $("body").append(tela);
$(".twins").append(c3.canvas);
writeText(c2.canvas, c2.context, "COMING SOON\n\nPROJECT\nTWINS");
